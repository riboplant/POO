...
public class ProductsTester {
   public static void main(String[] args) {
       ...
       Product iPhone = new Device("iPhone 13", apple, 1000, B);
       ...
       System.out.println(iPhone.getFinalPrice(BASICA)); // 1170.0
       ...
       System.out.println(airpods.getFinalPrice(PREMIUM)); // 575.0
