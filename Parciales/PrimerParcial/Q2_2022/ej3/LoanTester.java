...
public class LoanTester {
    public static void main(String[] args) {
        ...
        Loan l1 = new Loan(LoanType.PERSONAL, 1000, 3, LocalDate.of(2022,9,1));
        ...
        // y las fechas de los mismos deben ser posteriores a la fecha del préstamo
        Loan l2 = new Loan2(LoanType.CAR, 2000, 3, LocalDate.of(2022,9,1));
        ...
        Loan l3 = new Loan3(LoanType.HOME, 3000, 3, LocalDate.of(2022,9,1));
        ...
        try {
            ...
            new Loan(LoanType.PERSONAL, 75000, 3, LocalDate.of(2022,9,1));
        } catch (LoanException ex) {
        ...
        try {
            ...
            new Loan2(LoanType.CAR, 3000, 30, LocalDate.of(2022,9,1));
        } catch (LoanException ex) {
            System.out.println(ex.getMessage()); // Invalid Loan.
        }
    }
