...
public class MilesClientTester {
   ...
   public static void main(String[] args) {
       ...
       MilesClient chuck = new MilesClient("Chuck", 4, MilesPlan.CLUB2000);
       ...
       MilesClient sarah = new MilesClient("Sarah", 2, MilesPlan.CLUB1000);
       ...
       MilesClient morgan = new MilesClient("Morgan", 6, MilesPlan.CLUB5000);
